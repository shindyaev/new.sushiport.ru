 ...
 */
class Present extends EActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('restoranId, categoryId, dishId, price', 'required'),
			array('restoranId, categoryId, dishId, price, visible, cityId', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, categoryId, dishId, price, visible, cityId', 'safe', 'on'=>'search'),
		);
	}
