...
<div>
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<div class="control-group">
			<?php echo $form->label($model,'dish',array('class'=>'control-label')); ?>
			<div class="controls">
				<?php echo $form->textField($model,'dish',array('class'=>'m-wrap large')); ?><br>
				<span class="help-inline"><?php echo $form->error($model,'dish'); ?></span>
			</div>
		</div>
		...
		<div class="form-actions large">
			...
			<?php if (!empty($model->id)) : ?>
				<a href="/team/deleteWorker/<?php echo $model->id?>/" onclick="return confirmDelete()"><?php echo CHtml::htmlButton('<i class="icon-remove"></i> Удалить', array('class' => 'btn red', 'type' => 'button')); ?></a>
			<?php endif;?>
