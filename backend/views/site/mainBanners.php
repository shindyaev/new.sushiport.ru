...
$this->title_h3='Баннеры на главной';
...
$this->breadcrumbs_button = '<li class="pull-right no-text-shadow">
								<a class="btn blue dash-btn" href="'.$this->createUrl('site/bannerItem').'"><i class="icon-plus"></i>Добавить запись</a>
							</li>';
					...
					array(
						...
						'buttons'=>array(
							'view'=>array(
								...
								'url'=>function($data) {
									return '/site/bannerItem/'.$data['id'].'/';
								},
							),
							'add'=>array(
								...
								'click'=>'confirmDelete',
								'url'=>function($data) {
									return '/site/deleteBanner/'.$data['id'].'/';
								},
							),
						),
						'template'=>'{view} {add}',
