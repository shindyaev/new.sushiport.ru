	...
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<div class="form-actions large">
			...
			<?php if (!empty($model->id)) : ?>
				<a href="/news2/delete/<?php echo $model->id?>/" onclick="return confirmDelete()"><?php echo CHtml::htmlButton('<i class="icon-remove"></i> Удалить', array('class' => 'btn red', 'type' => 'button')); ?></a>
			<?php endif;?>
