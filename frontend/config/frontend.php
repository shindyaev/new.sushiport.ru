	...
	'components' => array(
		...
		'urlManager' => array(
			...
			'rules' => array(
				...
				// default rules
				'http://<city>.new.milimon.ru/<controller:\w+>/<id:\d+>' => '<controller>/index',
				'http://<city>.new.milimon.ru/<controller:\w+>' => '<controller>/index',
				'http://<city>.new.milimon.ru/<controller:\w+>/<action:\w+>/<id:\d+>' => '<controller>/<action>',
				'http://<city>.new.milimon.ru/<controller:\w+>/<action:\w+>' => '<controller>/<action>',
			),
		),
		'user' => array(
			'allowAutoLogin' => true,
